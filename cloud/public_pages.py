...
DESCRIPTION = (
    ...
    "подготовка аналитических записок и хранение отчётов. Облачная версия находится "
    "в подготовке: сейчас доступны вход через Google и проверка подключений. "
    "Публикации, редактор и архив будут подключены после переноса данных."
)
