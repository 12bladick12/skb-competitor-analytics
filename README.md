...
Сбор запускается по кнопке. Редактор выпускает новые Word/ZIP в неизменяемый архив.
...
В разделе «Черновики» редактор и администратор могут создать записку на период,
...
черновиков; каждый выпуск Word/ZIP отдельно сохраняется в архиве.

## Выпуск и сбор

В «Предпросмотре» сохраните правки и нажмите «Выпустить Word и ZIP».
