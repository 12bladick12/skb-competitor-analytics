...
**Это ещё не полный мониторинг.** Новый сбор и выпуск
новых документов подключаются следующим этапом. В этом репозитории нет рабочих баз,
...
черновиков; выпуск новых Word-отчётов и ZIP из редактора пока не подключён.
